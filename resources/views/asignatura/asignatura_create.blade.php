                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-select" id="exampleSelect1" name="titulacion_id">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <fieldset>
                                ...
                                <input class="form-control" value="{{$course}}"id="readOnlyInput" name="curso" type="text" placeholder="Readonly input here..." readonly="">
                            </fieldset>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input required autocomplete="off" name="nombre" class="form-control"
                                type="text" placeholder="Nombre Asignatura">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input required autocomplete="off" name="creditos" class="form-control"
                                type="number" placeholder="Asigne numeros de creditos">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input required autocomplete="off" name="alumnos_max" class="form-control"
                                type="number" placeholder="Alumnos máximos">
                        </div>
                    </div>
